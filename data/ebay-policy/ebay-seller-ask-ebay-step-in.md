---
doc_id: ebay-seller-ask-ebay-step-in
title: "Yêu cầu eBay can thiệp dành cho người bán"
source_url: "https://www.ebay.com/help/selling/managing-returns-refunds/ask-ebay-to-step-in?id=4702"
...
# Yêu cầu eBay can thiệp dành cho người bán
...
Once we step in, we'll review the details and get back to you and the buyer within 48 hours.
...
Go to Orders in Seller Hub and open the Returns or the Requests and disputes tab.
...
Find the order in My eBay Orders and select View return details.

Select Report problem, and follow the instructions from there.

For help with an item not received request:

Find the order in My eBay Orders and select View request details.

Select Ask eBay to step in and help, and follow the instructions from there.

Tip

Whenever possible, we recommend resolving your buyer's issue and not asking eBay to step in. If it's counted as a case closed without seller resolution, it may affect your seller performance level.
...
Top Takeaway
We recommend trying to resolve the buyer's issue within 3 business days. After that, we can step in and help. However, if we determine you were responsible for providing a resolution to the buyer, your seller performance level may be affected.
