...
When a buyer opens a return for a vehicle part or accessory covered by eBay Guaranteed Fit and selects the reason "Doesn't fit my vehicle", we'll cover the cost of an eBay return label. If the item doesn't qualify for an eBay return label, you'll be responsible for providing a way for the buyer to return the item.
